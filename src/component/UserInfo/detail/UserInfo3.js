...
export function UserInfo3({ nextPage }) {
        ...
        <div style={styles.container}>
            <div style={styles.container1}>
                ...
                <div style={styles.container3}>
                    <span style={styles.title}>당신의 소개글을 한 문장으로 알려주세요.</span>
                </div>
                <div style={styles.container3}>
                    <span style={styles.subtitle}>iGeport는 첫 페이지에 들어갈 이름입니다. <br/> 작성하지 않으셔도 괜찮습니다.</span>
                </div>
