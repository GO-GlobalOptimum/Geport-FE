...
export function UserInfo7({ nextPage }) {
        ...
        <div style={styles.container}>
            <div style={styles.container1}>
                ...
                <div style={styles.container3}>
                    <span style={styles.title}>마지막 단계입니다! 전화번호를 알려주세요</span>
                </div>
                <div style={styles.container3}>
                    <span style={styles.subtitle}>Geport가 생성되면 이 전화번호로 히든코드를 보내드릴 거예요. <br/> 정확한 정보를 입력했는지 꼼꼼하게 확인해주세요.</span>
                </div>
                <div style ={styles.container7}>
                    ...
                    <div style={styles.pageCount}>
                        <svg width="10" height="260" viewBox="0 0 10 260" fill="none"
                            ...
                            <circle cx="5" cy="255" r="5" transform="rotate(90 5 255)" fill="#1AE57C"/>
                        </svg>
                    </div>
                </div>
