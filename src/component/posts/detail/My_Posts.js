...
export function My_Posts(props){
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                                    <div style={{ marginRight: '10px', flex: '1' }}>
                                        ...
                                        <div key={post.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                                            ...
                                            <div>
                                                <button style={{ marginRight: '10px', padding: '5px 10px', borderRadius: '20px', backgroundColor: '#DDDDDD', border: 'none' }}>통계</button>
                                                <button style={{ marginRight: '10px', padding: '5px 10px', borderRadius: '20px', backgroundColor: '#DDDDDD', border: 'none' }}>수정</button>
                                                <button style={{ padding: '5px 10px', borderRadius: '20px', backgroundColor: '#DDDDDD', border: 'none' }}>삭제</button>
                                            </div>
                                        </div>
