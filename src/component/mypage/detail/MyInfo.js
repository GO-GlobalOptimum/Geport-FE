    ...
    return(
        <div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
                <img src={"./image/Logo.png"} style={{ marginRight: '10px', width: '150px', height: '30px', padding: "1%", cursor: "pointer", borderRadius: "5px", border: "1px solid #ccc" }} onClick={logoClick} />
                <div style={{ position: 'relative', display: 'flex', alignItems: 'center', background: "#ccc", borderRadius: '50px', border: '1px solid #ccc', padding: '5px', height: '30px' }}>
